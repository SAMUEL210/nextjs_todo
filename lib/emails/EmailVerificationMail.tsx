        ...
        <Body style={main}>
            ...
            <Container style={container}>
                ...
                <Text style={paragraph}>
                    Bienvenu sur Tache, pour finaliser votre inscription, veuillez
                    cliquer sur le bouton ci-dessous pour activer votre compte.
                </Text>
                ...
                <Text style={paragraph}>
                    Si vous n&apos;avez pas demandé cette activation, vous pouvez ignorer ce message.
                </Text>
                <Text style={paragraph}>
                    Merci
                    <br />
